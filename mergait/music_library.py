...
class MusicLibrary:
    ...
    def setSpotify(self, client_id, client_sectret):
        '''
    ...
    def getDataFrames(self):
        ...
        '''
        return self.df_tracks, self.df_features, self.df_analysis, self.df_sections, self.df_segments, self.df_artists
    ...
    def require_tracks(self, track_uris):
        ...
        known_uris = [] if len(self.df_tracks) == 0 else set(
            self.df_tracks['uri'].values)
    ...
    def __spotify_tracks(self, track_uris):
        ...
        for track_info in track_dict['tracks']:
            ...
            df_segments['uri'] = track_info['uri']
            ...
            if len(self.df_artists
                   ) == 0 or artist_uri not in self.df_artists['uri']:
